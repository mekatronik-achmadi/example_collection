...
u_int8_t m8515::fuse_default(u_int8_t fuse_part){
...
u_int8_t m8515::fuse_restrict(u_int8_t fuse_part){
    u_int8_t result=0x00;
...
QStringList m8515::fuse_string(u_int8_t fuse_part){
    QStringList result;
...
QStringList m8515::fuse_tooltip(u_int8_t fuse_part){
    QStringList result;
    ...
    if(fuse_part==LFUSE){
        ...
        result << "AT90S4414/8515 Compatible";
    }
    else if(fuse_part==EFUSE){
        u_int8_t i;
        for(i=0;i<8;i++){
...
u_int8_t m8515::bod_get(u_int8_t fuse_part, u_int8_t fuse_input, int8_t menu_index){
...
u_int8_t m8515::bod_set(u_int8_t lfuse_input, u_int8_t hfuse_input, u_int8_t efuse_input){
    (void) hfuse_input;
    (void) efuse_input;
...
QStringList m8515::bootsz_string(){
    QStringList result;
...
u_int8_t m8515::bootsz_get(u_int8_t fuse_part, u_int8_t fuse_input, int8_t menu_index){
...
u_int8_t m8515::bootsz_set(u_int8_t lfuse_input, u_int8_t hfuse_input, u_int8_t efuse_input){
    (void) lfuse_input;
    (void) efuse_input;
...
u_int8_t m8515::osc_get(u_int8_t fuse_part, u_int8_t fuse_input, int8_t menu_index){
...
u_int8_t m8515::osc_set(u_int8_t lfuse_input, u_int8_t hfuse_input, u_int8_t efuse_input){
    (void) hfuse_input;
    (void) efuse_input;
