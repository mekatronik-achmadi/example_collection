...
static GFXINLINE void init_board(GDisplay *g) {
  ...
  palSetPadMode(GPIOB, 10, PAL_MODE_ALTERNATE(5)|PAL_STM32_OSPEED_HIGHEST);

  palSetPadMode(GPIOB, LCD_CS, PAL_MODE_OUTPUT_PUSHPULL|PAL_STM32_OSPEED_HIGHEST);
  palSetPadMode(GPIOB, LCD_DC, PAL_MODE_OUTPUT_PUSHPULL|PAL_STM32_OSPEED_HIGHEST);
  palSetPadMode(GPIOB, LCD_RES, PAL_MODE_OUTPUT_PUSHPULL|PAL_STM32_OSPEED_HIGHEST);
