...
ftulis = fopen('JST_AND_PRECEPTRON(MATLAB).txt','w');
disp('Metode Perceptron, Pengenalan fungsi AND');
fprintf(ftulis,'Metode Perceptron, Pengenalan fungsi AND\n');
disp('Inisialisai : ');
...
fclose(ftulis);
edit JST_AND_PRECEPTRON(MATLAB).txt   
