...
ftulis = fopen('JST_OR_ADALINE(MATLAB).txt','w');
disp('Metode Adaline, Pengenalan fungsi OR');
fprintf(ftulis,'Metode Adaline, Pengenalan fungsi OR\n');
disp('Inisialisai : ');
...
fclose(ftulis);
edit JST_OR_ADALINE(MATLAB).txt;
