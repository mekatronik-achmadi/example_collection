...
UB = [800 2700 0.5 0.2];% Upper Bounds diganti sesuai dengan constraint fungsi objektif
LB = [700 2600 0 0];% Lower Bounds diganti sesuai dengan constraint fungsi objektif
