function [ xp ] = l1eqpd( x0, A, At, b, pdtol, pdmaxiter, cgtol, cgmaxiter )
% L1 equalization to solve LP
%
...
% check input A is function_hancdle or not (?)
largescale = isa(A,'function_handle');

% default value based on input parameter count
...
% run second and next iteration while done condition unsatisfied
while(~done)
    pditer = pditer + 1;
